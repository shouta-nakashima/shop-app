  ...
  return (
    <Document>
      <Page style={styles.body}>
        ...
        <Text style={styles.author}>Nakaji's shop app Demo</Text>
        ...
        <Table data={order.products}>
          <TableBody>
            ...
            <DataTableCell getContent={(x) => `${x.product.price.toLocaleString()}`} />
        ...
        <Text style={styles.footer}>~ Thank you for shopping with as ~ { "\n"} { "\n"} ©︎2020 Nakaji's shop app Demo</Text>
      </Page>
    </Document>
  )
}
